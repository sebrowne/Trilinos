...
EXTRA_C_FLAGS="-g1 -mkl -qoverride-limits"
EXTRA_CXX_FLAGS="-g1 -mkl -qoverride-limits"
...
cmake \
   ...
   -D BLAS_LIBRARY_DIRS:PATH="${BLAS_DIR}/lib/intel64;${BLAS_DIR}/compiler/lib/intel64" \
   -D BLAS_LIBRARY_NAMES:STRING="mkl_intel_lp64;mkl_intel_thread;mkl_core;iomp5" \
   \
   -D TPL_ENABLE_LAPACK=ON \
   -D LAPACK_LIBRARY_DIRS:PATH="${LAPACK_DIR}/lib/intel64;${LAPACK_DIR}/compiler/lib/intel64" \
   ...
   -D TPL_ParMETIS_LIBRARIES="${PARMETIS_DIR}/lib/libparmetis.a;${METIS_DIR}/lib/libmetis.a" \
   \
   ...
   -D SuperLUDist_LIBRARY_NAMES:STRING="superlu_dist_4.3;parmetis;metis" \
   \
