...
#
# Configure and then build and install Mini-Trilinos for SPARC using:
#
#   cd Trilinos/
#   mkdir <build-dir>/
#   cd <build-dir>/
...
cmake \
$GENERATOR \
-D Trilinos_CONFIGURE_OPTIONS_FILE:STRING=cmake/std/atdm/apps/sparc/SPARCMiniTrilinosPackagesEnables,cmake/std/atdm/ATDMDevEnv.cmake \
"$@" \
..
