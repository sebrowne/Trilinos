...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scan for preprocessor macros related to deprecated Trilinos packages and remove them appropriately with `unifdef`")
