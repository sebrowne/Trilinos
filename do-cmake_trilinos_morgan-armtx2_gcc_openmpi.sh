...
MPI_DIR=${MPI_ROOT}
BLAS_DIR=${OPENBLAS_ROOT}
LAPACK_DIR=${OPENBLAS_ROOT}
HDF5_DIR=${HDF5_ROOT}
...
cmake \
   ...
   -D BLAS_LIBRARY_NAMES:STRING="blas;gomp" \
   \
   -D TPL_ENABLE_LAPACK=ON \
   -D LAPACK_LIBRARY_DIRS:PATH="${LAPACK_DIR}/lib" \
   -D LAPACK_LIBRARY_NAMES:STRING="lapack;gomp" \
   \
   ...
   -D CGNS_LIBRARY_NAMES:STRING="cgns;hdf5" \
   \
   -D TPL_ENABLE_METIS=ON \
   -D METIS_INCLUDE_DIRS:PATH=${METIS_DIR}/include \
   -D TPL_METIS_LIBRARIES:PATH="${METIS_DIR}/lib/libmetis.a" \
   \
   -D TPL_ENABLE_ParMETIS=ON \
   -D ParMETIS_INCLUDE_DIRS:PATH=${PARMETIS_DIR}/include \
   -D TPL_ParMETIS_LIBRARIES:PATH="${PARMETIS_DIR}/lib/libparmetis.a;${METIS_DIR}/lib/libmetis.a" \
   \
